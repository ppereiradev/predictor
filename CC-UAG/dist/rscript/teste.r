...
metodo_principal <- function(coluna, limite_recurso, frequencia, start_ts, end_ts, horizonte, drift, r_linear, 
                             s_exponential, holt, hw, arima, width_n, height_n, x_label, y_label){
  ...
  if(drift){
    ...
    png(filename = 'drift.png', width = width_n, height = height_n, units = 'px')
  ...
  if(r_linear){
    ...
    png(filename = 'linear_regression.png', width = width_n, height = height_n, units = 'px')
  ...
  if(s_exponential){
    ...
    png(filename = 'simple_exponential.png', width = width_n, height = height_n, units = 'px')
  ...
  if(holt){
    ...
    png(filename = 'holt.png', width = width_n, height = height_n, units = 'px')
  ...
  if(hw){
    ...
    png(filename = 'hw.png', width = width_n, height = height_n, units = 'px')
  ...
  if(arima){
    ...
    png(filename = 'arima.png', width = width_n, height = height_n, units = 'px')
  ...
  if((which.min(acuracia_mape) == 1 | which.min(acuracia_mae) == 1) & drift == TRUE){
    ...
    png(filename = 'best.png', width = width_n, height = height_n, units = 'px')
